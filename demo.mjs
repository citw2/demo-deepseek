#!/usr/bin/env node
// SAIHM memory for DeepSeek — one client-side-encrypted memory you own; provable forget.
//
//   git clone https://github.com/citw2/demo-deepseek
//   cd demo-deepseek && npm install && node demo.mjs
//
// Optional, for a LIVE DeepSeek answer instead of the offline mock:
